      ...
      <section className="main_vacancys">
        <div className="container">
          <form className="sort_form">
            <input className='text-white' placeholder="Izlash..." onChange={inputSortOn} type="text" />
            <select onChange={onChangeSelect} name="sort_category">
              <option selected disabled >Markasi boyicha sortlash</option>
          ...
          <div className="main_vacancys_inner">
            {inputSort.length
              ? inputSort.map((el) => {
                  return <CarCard key={el.id} obj={el} />;
                })
              : selectSort.length
              ? selectSort.map((el) => {
                  return <CarCard key={el.id} obj={el} />;
